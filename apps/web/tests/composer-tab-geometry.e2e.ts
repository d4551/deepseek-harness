...
describe('web e2e: input card position across view tabs', () => {
  ...
  if (SKIP_IN_RECORD_MODE) console.info('[skip] composer-tab-geometry.e2e.ts: record mode refreshes fixtures; this replay-only assertion runs in replay/refresh')
