...
flowchart LR
  ...
  plugin_dsh_base_tool_agent_team["tool-agent-team<br/>@deepseek-ai/dsh-tool-agent-team"]
  cfg --> plugin_dsh_base_tool_agent_team
...
| `tool-agent-team` | `@deepseek-ai/dsh-tool-agent-team` |
