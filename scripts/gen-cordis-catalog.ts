...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionSetWorkspaceRootsRequest: 'session.md',
  SessionSetWorkspaceRootsValue: 'session.md',
  SessionWorkspaceOrigin: 'session.md',
  ...
  DriveByteRange: 'filesystem.md',
  DriveContent: 'filesystem.md',
  DriveDirEntry: 'filesystem.md',
  DrivePath: 'filesystem.md',
  DriveStat: 'filesystem.md',
  DriveVersion: 'filesystem.md',
  DriveWriteIntent: 'filesystem.md',
  ...
  ClaimNextTeamTaskResult: 'agent-team.md',
  ...
  TeamProgressResult: 'agent-team.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  BashEnvContributor: 'service-local extension type is owned by packages/shell/tool-shell/src/index.ts',
  BashEnvVariableInfo: 'service-local metadata type is owned by packages/shell/tool-shell/src/index.ts',
