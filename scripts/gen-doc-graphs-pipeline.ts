/**
 * Curated tool-execution pipeline graph for {@link ./gen-doc-graphs.ts}.
 */

import { generatedHeader, maintenanceFooter, mermaidCode } from './gen-doc-graphs-markdown.ts'

/** Curated tool execution pipeline mermaid page. */
export function renderToolPipeline(): string {
