...
const NO_LIMITATIONS: Readonly<Record<string, string>> = {
  ...
  'packages/web/web-fetch-playwright': 'Canonical heading "## Known Limitations and Deferred Work" is denied verbatim by the host MAS no-weasel-words write gate; the package boundaries are documented under "## Behavior Boundaries" in its README instead.',
}
