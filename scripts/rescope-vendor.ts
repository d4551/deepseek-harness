...
const POSTCONDITIONS: readonly PostCondition[] = [
  ...
  { file: 'scripts/cordis-walk.ts', text: '!== \'@deepseek-ai/cordis\'', count: 1 },
  { file: 'scripts/gen-scoped-events-scan.ts', text: '=== \'@deepseek-ai/cordis\'', count: 1 },
  { file: 'packages/typert/generator/src/analyzer-collect.ts', text: '!== \'@deepseek-ai/cordis\'', count: 1 },
