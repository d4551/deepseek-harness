...
- **`break` is the recorded score, and only moves up.** The scope's measured score is 95.98 — 780 killed plus 7 timed out of 820 reachable mutants — and the threshold sits at 95.

## What the survivors are

The 33 survivors are not missing assertions; they are mutants no assertion over the public result can reach, and the distinction is what keeps the number meaningful:
