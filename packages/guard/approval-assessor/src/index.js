 ...
 */
const SAFETY_GATE_TOOLS = new Set([
    'bash',
    'pwsh',
    'write',
    'edit',
 ...
 */
function buildPatterns(extras) {
    const compiled = [...EVASION_PATTERNS];
 ...
 */
function isEvasion(req, patterns) {
    if (SAFETY_GATE_TOOLS.has(req.toolName))
        return false;
 ...
 */
function rejectionMessage(toolName, instruction) {
