...
The package name is settled. The [naming ledger](../../../.agents/notes/implemented/architecture/2026-08-11-repository-naming-contract-and-rename-ledger.md) records `@deepseek-ai/dsh-tool-call-timeout-policy`, keeping the `guard/timeout-policy/` directory and the `timeout-policy` plugin id; it supersedes the `@deepseek-ai/dsh-timeout-guard` target the [package-regrouping decision](../../../.agents/notes/implemented/architecture/2026-07-29-package-regrouping.md) deferred.
