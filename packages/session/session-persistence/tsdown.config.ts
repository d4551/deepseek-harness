 ...
 * `./coordinated` subpath declared in `package.json` needs its own bundle or a
 * packed install resolves it to a missing file.
 */
export default defineConfig([
  ...
  {
    entry: ['lib/types/coordinated.js'], outDir: 'lib', format: ['esm'], platform: 'node', target: 'es2024',
    fixedExtension: false, outputOptions: { codeSplitting: false }, dts: false, clean: false,
  },
])
