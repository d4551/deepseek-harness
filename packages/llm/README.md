...
| [`llm-litert/`](llm-litert/README.md) | Serves LiteRT-LM models, importing them and supervising `litert-lm serve` or pointing at a running one | registers on `ctx.llm` |
