...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-approval/src/client/contract/slots.ts:26',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-request-budget, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      ...
      'client-ui-chat TurnRequestBudgetNodeView key \'turn-request-budget\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace-roots WorkspaceRootsAction id \'workspace-roots\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins ApprovalAdversaryCard',
      ...
      'client-ui-settings-plugins AgentTeamCard',
      'client-ui-settings-plugins WebAccessCard',
