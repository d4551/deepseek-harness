 ...
 * again instead of discovering the failure at run time. `vm.Script` compiles
 * the wrapped body and does not run it. A SyntaxError carries the
 * source-line-and-caret prelude the teaching text builds on.
