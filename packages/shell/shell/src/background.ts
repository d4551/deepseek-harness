/**
 * Generic-task adaptation for background shell process handles, shared by the
 * shell tool Consumers that register their handles with `ctx.jobs`.
 * @module dsh-shell/background
 */
