#!/usr/bin/env node
/**
 * Test driver: boot the pwsh-dialect tool-shell Loader composition, execute one real
...
if (configPath === undefined) throw new Error('pwsh-dialect driver requires a config path')

const ctx = await boot('tool-shell-pwsh-loader-smoke', resolveConfigPath(configPath, undefined))
try {
