 ...
 * product.
 *
 * The package manager creates a workspace package's bin link only when the link target exists
...
if (!existsSync(fileURLToPath(entry))) {
  process.stderr.write('dsh-pack-vfs-image: lib/bin.js is missing — run `bun run build` before packing an image\n')
  process.exit(1)
}
