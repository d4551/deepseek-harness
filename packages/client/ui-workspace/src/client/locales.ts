...
export const zh = {
  ...
  'menu.archiveSelected.one': '归档选中的 {n} 个会话',
  'menu.archiveSelected.other': '归档选中的 {n} 个会话',
  'selection.count.one': '已选择 {n} 个会话',
  'selection.count.other': '已选择 {n} 个会话',
...
export const en = {
  ...
  'fork.error': 'Couldn’t fork session',
  'menu.archiveSession': 'Archive session',
  'menu.archiveSelected.one': 'Archive {n} session',
  'menu.archiveSelected.other': 'Archive {n} sessions',
  'selection.count.one': '{n} session selected',
  'selection.count.other': '{n} sessions selected',
