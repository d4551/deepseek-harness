/**
 * Descendant-count fold over the Session Controller list, shared by every
 * surface that renders subagent lineage.
 * @module @deepseek-ai/dsh-client-ui-session/src/client/subagent-lineage
 */

import type { SessionId } from '@deepseek-ai/dsh-session/types'

/** The Session-summary fields the lineage walk reads. */
