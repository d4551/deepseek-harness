...
export function InputBar({
  ...
  renderSlot, useNotices, useMenuLauncher,
  ...
  // The lexicon hook seat stays bound by the inject compartment; text-ref decoration rides the shell's editor transforms.
