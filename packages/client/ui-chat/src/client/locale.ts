...
export const zh = {
  ...
  'message.requestBudget': '已达到请求上限，自动执行已暂停',
  'message.requestBudget.usage': '此代理：{actor}/{actorLimit} 次请求；整个任务：{root}/{rootLimit} 次请求。',
  'message.requestBudget.hint': '已有工作和请求记录均已保留。请在主会话发送明确的后续消息，以授权继续执行；尚未完成的检查仍须通过。',
...
export const en = {
  ...
  'message.branchError': 'Couldn’t fork session',
  ...
  'message.requestBudget': 'Request limit reached — automatic work paused',
  'message.requestBudget.usage': 'This agent: {actor}/{actorLimit} requests; whole task: {root}/{rootLimit} requests.',
  'message.requestBudget.hint': 'Prior work and request charges are preserved. Send an explicit follow-up in the root conversation to authorize more work. Outstanding checks still need to pass.',
