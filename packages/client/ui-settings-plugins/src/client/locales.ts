...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webFetchBrowserMissing: 'No browser installation was found. Browser search and rendered fetch require the Chromium installation belonging to this deployment’s Playwright package.',
  webApiKey: 'API key',
  ...
  webFetchPlaywrightTitle: 'Browser search and fetch',
  webFetchPlaywrightDescription: 'Searches Bing and renders pages in local Chromium without a paid search API. Search engines may require human verification.',
  ...
  webFetchMaxConcurrentRendersHint: 'How many searches and fetches may hold a browser context at once.',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webFetchBrowserMissing: '未找到浏览器安装。浏览器搜索和渲染抓取需要安装本部署 Playwright 软件包对应的 Chromium。',
  webApiKey: 'API Key',
  webApiKeySet: '已配置密钥。',
  ...
  webFetchPlaywrightTitle: '浏览器搜索和抓取',
  webFetchPlaywrightDescription: '使用本地 Chromium 搜索 Bing 并渲染网页，无需付费搜索 API。搜索引擎可能要求人工验证。',
  ...
  webFetchMaxConcurrentRendersHint: '最多允许多少次搜索和抓取同时占用浏览器上下文。',
  webFetchUserAgent: 'User-Agent',
