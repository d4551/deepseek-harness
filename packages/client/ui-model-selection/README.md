...
The composer menu stays anchored to its trigger and changes sides when it would cross a viewport edge. Keyboard navigation supports model and effort selection without moving focus into the composer.
