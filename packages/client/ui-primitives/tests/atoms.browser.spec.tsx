...
describe('Button', () => {
  it('renders children, icon, and forwards clicks', () => {
    const onClick = vi.fn<(...args: never[]) => void>()
...
describe('Input', () => {
  it('forwards value/onChange and renders the leading icon', () => {
    const onChange = vi.fn<(...args: never[]) => void>()
...
describe('Menu', () => {
  ...
  it('shows items only while open; select fires onSelect', () => {
    const onSelect = vi.fn<(...args: never[]) => void>()
  ...
  it('a list click does not bubble to the anchor row (portal synthetic-event path)', () => {
    const rowClick = vi.fn<(...args: never[]) => void>()
    render(
...
describe('Modal', () => {
  ...
  it('keeps portaled menu selection and Escape inside the owning dialog', () => {
    const close = vi.fn<(...args: never[]) => void>()
    const select = vi.fn<(...args: never[]) => void>()
  ...
  it('contains focus and restores the caller and background when closed', () => {
    ...
    trigger.focus()
    const modal = render(<Modal open onClose={vi.fn<(...args: never[]) => void>()} title="Task" closeLabel="Close" />)
