...
/** Activity and outcome semantics, including a neutral inactive state. */
export type StateDotState = 'done' | 'warning' | 'ongoing' | 'error' | 'inactive'
...
/**
 * Render a state dot.
 * @param props.state - activity or outcome to show.
