...
import { indexSubagentDescendants } from '../src/subagent-lineage.ts'

const sid = (id: string): SessionId => id as SessionId

describe('Session descendant projection', () => {
  it('counts nested running descendants and climbs through an ordinary fork', () => {
  ...
  it('stops at an ordinary fork that opens no subagent of its own', () => {
