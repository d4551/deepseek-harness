 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(?:file-reference|session|llm|tools|brand|util-crypto|util-workspace-path)(?:\/|$)|@deepseek-ai\/dsh-token-meter\/client$|@deepseek-ai\/dsh-cordis-host-runner\/wire-values$|@deepseek-ai\/dsh-compaction\/checkpoint$|@deepseek-ai\/dsh-commands\/brand$)/
