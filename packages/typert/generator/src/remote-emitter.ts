...
/**
 * Append the shared schema-definition preamble every generated module uses:
 * the zod import when definitions exist, the definitions themselves, and a
 * separating blank line.
 * @param lines - artifact lines under construction.
 * @param schemas - emitted schema artifact.
 */
export function pushSchemaDefinitions(lines: string[], schemas: SchemaArtifact): void {
...
/**
 * Append an indented invocation-descriptor list property, shared by the
 * runtime TYPERT literal and the Remote TYPERT_REMOTE literal.
 * @param lines - artifact lines under construction.
 * @param invocations - modeled Remote invocations.
 * @param schemas - emitted schema artifact with boundary codecs.
 * @param property - emitted property name (`invocations` or `descriptors`).
 */
export function pushInvocationDescriptorList(
  lines: string[],
  invocations: readonly InvocationModel[],
...
export class RemoteModelEmitter {
  ...
  emit(packageModel: PackageModel): RemoteModelEmitResult {
    ...
    pushInvocationDescriptorList(lines, packageModel.invocations, schemas, 'descriptors')
    lines.push('}')
    lines.push('')
