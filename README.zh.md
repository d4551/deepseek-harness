...
- **TypeScript 7**（`typescript` ^7.0.2）编译 Host 与 Client program。调用 compiler API 的脚本和 Typert generator 导入 `@typescript/typescript6`，因为 TypeScript 7.0 尚未提供稳定的 programmatic API。
