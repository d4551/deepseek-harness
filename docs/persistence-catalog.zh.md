<!-- 英文源文件由 scripts/gen-persistence-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `bun run gen-persistence-catalog` 更新英文，再更新本文件并运行 `bun run verify-translation-pairing --write docs/persistence-catalog.md` 重新记录配对。 -->
...
来源：[`packages/core/agent/src/message-receipt.ts:15`](../packages/core/agent/src/message-receipt.ts)
...
<a id="requestattempt--log-only"></a>

#### `request/attempt` — log-only
...
来源：[`packages/core/session/src/request-budget-types.ts:63`](../packages/core/session/src/request-budget-types.ts)
...
来源：[`packages/core/session/src/request-budget-types.ts:56`](../packages/core/session/src/request-budget-types.ts)
...
来源：[`packages/session/session-title/src/index.ts:102`](../packages/session/session-title/src/index.ts)
...
来源：[`packages/subagent/agent-team/src/types.ts:276`](../packages/subagent/agent-team/src/types.ts)
...
来源：[`packages/subagent/agent-team/src/types.ts:274`](../packages/subagent/agent-team/src/types.ts)
...
来源：[`packages/subagent/agent-team/src/types.ts:272`](../packages/subagent/agent-team/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:231`](../packages/core/session/src/types.ts)
