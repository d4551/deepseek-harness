<!-- 英文源文件由 scripts/gen-module-graph.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `bun run gen-module-graph` 更新英文，再更新本文件并运行 `bun run verify-translation-pairing --write docs/module-graph.md` 重新记录配对。 -->
...
flowchart TD
  subgraph group_util["packages/util"]
    ...
    pkg_brand["brand"]
    pkg_browser_locale["browser-locale"]
    pkg_capacity_gate["capacity-gate"]
    pkg_diagnostic_text["diagnostic-text"]
    pkg_document_queue["document-queue"]
    pkg_home_paths["home-paths"]
    pkg_keyed_lock["keyed-lock"]
    pkg_launch_environment["launch-environment"]
    pkg_native_command["native-command"]
    pkg_output_retention["output-retention"]
    pkg_sqlite_connection["sqlite-connection"]
    pkg_timeout["timeout"]
  ...
  subgraph group_fs["packages/fs"]
    ...
    pkg_fs_network_drive["fs-network-drive"]
    pkg_fs_observation_policy["fs-observation-policy"]
    pkg_fs_sandbox["fs-sandbox"]
    pkg_network_drive["network-drive"]
    pkg_network_drive_webdav["network-drive-webdav"]
    pkg_tool_fs["tool-fs"]
  ...
  subgraph group_web["packages/web"]
    ...
    pkg_web_fetch_playwright["web-fetch-playwright"]
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_projection["client-ui-projection"]
    ...
    pkg_client_ui_workspace_roots["client-ui-workspace-roots"]
  ...
  subgraph group_guard["packages/guard"]
    pkg_approval_adversary["approval-adversary"]
    pkg_approval_assessor["approval-assessor"]
  ...
  subgraph group_shell["packages/shell"]
    ...
    pkg_tool_shell["tool-shell"]
    pkg_tool_shell_persistent["tool-shell-persistent"]
  end
  ...
  pkg_browser_locale --> pkg_invariants
  pkg_capacity_gate --> pkg_invariants
  pkg_diagnostic_text --> pkg_invariants
  pkg_home_paths --> pkg_invariants
  pkg_keyed_lock --> pkg_invariants
  pkg_launch_environment --> pkg_invariants
  pkg_native_command --> pkg_invariants
  pkg_output_retention --> pkg_invariants
  pkg_sqlite_connection --> pkg_invariants
  ...
  pkg_client_ui_projection --> pkg_invariants
  ...
  pkg_storage_sqlite --> pkg_sqlite_connection
  ...
  pkg_credentials_local --> pkg_document_queue
  ...
  pkg_network_drive --> pkg_brand
  pkg_network_drive --> pkg_invariants
  pkg_network_drive --> pkg_llm
  ...
  pkg_network_drive_webdav --> pkg_credentials
  pkg_network_drive_webdav --> pkg_invariants
  pkg_network_drive_webdav --> pkg_network_drive
  ...
  pkg_session_persistence_sqlite --> pkg_sqlite_connection
  ...
  pkg_settings_file --> pkg_document_queue
  ...
  pkg_fs_local --> pkg_keyed_lock
  pkg_fs_network_drive --> pkg_fs
  pkg_fs_network_drive --> pkg_invariants
  pkg_fs_network_drive --> pkg_keyed_lock
  pkg_fs_network_drive --> pkg_llm
  pkg_fs_network_drive --> pkg_network_drive
  pkg_fs_network_drive --> pkg_sandbox
  ...
  pkg_web_fetch_http --> pkg_settings
  ...
  pkg_approval_adversary --> pkg_agent
  pkg_approval_adversary --> pkg_invariants
  pkg_approval_adversary --> pkg_llm
  pkg_approval_adversary --> pkg_session
  pkg_approval_adversary --> pkg_settings
  pkg_approval_adversary --> pkg_timeout
  pkg_approval_adversary --> pkg_user_approval
  pkg_approval_assessor --> pkg_agent
  pkg_approval_assessor --> pkg_invariants
  pkg_approval_assessor --> pkg_llm
  pkg_approval_assessor --> pkg_session
  pkg_approval_assessor --> pkg_settings
  pkg_approval_assessor --> pkg_user_approval
  ...
  pkg_llm_litert --> pkg_invariants
  pkg_llm_litert --> pkg_llm
  pkg_llm_litert --> pkg_llm_pi_ai
  pkg_llm_litert --> pkg_subprocess
  pkg_llm_litert --> pkg_timeout
  ...
  pkg_web_fetch_playwright --> pkg_capacity_gate
  pkg_web_fetch_playwright --> pkg_invariants
  pkg_web_fetch_playwright --> pkg_settings
  pkg_web_fetch_playwright --> pkg_timeout
  pkg_web_fetch_playwright --> pkg_web
  pkg_web_fetch_playwright --> pkg_web_fetch_http
  ...
  pkg_hook_protocol --> pkg_agent
  pkg_hook_protocol --> pkg_invariants
  pkg_hook_protocol --> pkg_llm
  pkg_hook_protocol --> pkg_session
  pkg_hook_protocol --> pkg_session_persistence
  pkg_hook_protocol --> pkg_shell
  pkg_hook_protocol --> pkg_tools
  pkg_hosted_drive --> pkg_fs
  pkg_hosted_drive --> pkg_fs_network_drive
  pkg_hosted_drive --> pkg_invariants
  pkg_hosted_drive --> pkg_sandbox
  pkg_hosted_drive --> pkg_sandbox_policy
  ...
  pkg_tool_shell_persistent --> pkg_agent
  pkg_tool_shell_persistent --> pkg_invariants
  pkg_tool_shell_persistent --> pkg_terminal
  pkg_tool_shell_persistent --> pkg_timeout
  pkg_tool_shell_persistent --> pkg_tools
  ...
  pkg_tool_shell --> pkg_agent
  pkg_tool_shell --> pkg_invariants
  pkg_tool_shell --> pkg_jobs
  pkg_tool_shell --> pkg_llm
  pkg_tool_shell --> pkg_sandbox
  pkg_tool_shell --> pkg_sandbox_policy
  pkg_tool_shell --> pkg_shell
  pkg_tool_shell --> pkg_shell_env
  pkg_tool_shell --> pkg_system_prompt
  pkg_tool_shell --> pkg_tools
  pkg_tool_shell --> pkg_user_approval
  ...
  pkg_subagent --> pkg_capacity_gate
  ...
  pkg_session_query_sqlite --> pkg_sqlite_connection
  ...
  pkg_workflow_worker_thread --> pkg_capacity_gate
  ...
  pkg_tool_agent_team --> pkg_commands
  ...
  pkg_api_remotes --> pkg_agent_default_model
  ...
  pkg_api_remotes --> pkg_tool_subagent
  ...
  pkg_agent_spine_demo --> pkg_tool_shell
  ...
  pkg_client_ui_settings_plugins --> pkg_api_session_controller
  ...
  pkg_cordis_client_runner --> pkg_cordis_host_runner
  ...
  pkg_client_ui_workspace --> pkg_host_directory_picker
  ...
  pkg_client_ui_agent_team --> pkg_agent_team
  pkg_client_ui_agent_team --> pkg_api_remotes
  pkg_client_ui_agent_team --> pkg_api_session_controller
  pkg_client_ui_agent_team --> pkg_client_locale
  pkg_client_ui_agent_team --> pkg_client_ui_conversation
  pkg_client_ui_agent_team --> pkg_client_ui_renderer
  pkg_client_ui_agent_team --> pkg_client_ui_session
  pkg_client_ui_agent_team --> pkg_invariants
  pkg_client_ui_agent_team --> pkg_session
  pkg_client_ui_agent_team --> pkg_typert_protocol
  ...
  pkg_client_ui_directory_picker_browse --> pkg_host_directory_picker
  ...
  pkg_client_ui_workspace_roots --> pkg_api_remotes
  pkg_client_ui_workspace_roots --> pkg_api_session_controller
  pkg_client_ui_workspace_roots --> pkg_client_locale
  pkg_client_ui_workspace_roots --> pkg_client_ui_conversation
  pkg_client_ui_workspace_roots --> pkg_client_ui_renderer
  pkg_client_ui_workspace_roots --> pkg_client_ui_session
  pkg_client_ui_workspace_roots --> pkg_client_ui_workspace
  pkg_client_ui_workspace_roots --> pkg_invariants
  pkg_client_ui_workspace_roots --> pkg_session
  pkg_client_ui_workspace_roots --> pkg_typert_protocol
...
| [`browser-locale`](../packages/util/browser-locale) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`capacity-gate`](../packages/util/capacity-gate) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`diagnostic-text`](../packages/util/diagnostic-text) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`home-paths`](../packages/util/home-paths) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`keyed-lock`](../packages/util/keyed-lock) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`sqlite-connection`](../packages/util/sqlite-connection) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-projection`](../packages/client/ui-projection) | `client` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`document-queue`](../packages/util/document-queue) | `util` | [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-web`](../packages/client/web) | `client` | [`browser-locale`](../packages/util/browser-locale), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`storage-sqlite`](../packages/storage/storage-sqlite) | `storage` | [`invariants`](../packages/runtime-diagnostics/invariants), [`sqlite-connection`](../packages/util/sqlite-connection), [`storage`](../packages/storage/storage) |
...
| [`credentials-local`](../packages/credentials/credentials-local) | `credentials` | [`atomic-write`](../packages/util/atomic-write), [`credentials`](../packages/credentials/credentials), [`document-queue`](../packages/util/document-queue), [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants), [`launch-environment`](../packages/util/launch-environment) |
...
| [`network-drive`](../packages/fs/network-drive) | `fs` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm) |
...
| [`network-drive-webdav`](../packages/fs/network-drive-webdav) | `fs` | [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants), [`network-drive`](../packages/fs/network-drive) |
...
| [`session-persistence-sqlite`](../packages/session/session-persistence-sqlite) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`sqlite-connection`](../packages/util/sqlite-connection) |
...
| [`settings-file`](../packages/settings/settings-file) | `settings` | [`atomic-write`](../packages/util/atomic-write), [`document-queue`](../packages/util/document-queue), [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings) |
| [`shell`](../packages/shell/shell) | `shell` | [`invariants`](../packages/runtime-diagnostics/invariants), [`sandbox`](../packages/sandbox/sandbox), [`settings`](../packages/settings/settings), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout) |
...
| [`fs-local`](../packages/fs/fs-local) | `fs` | [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`keyed-lock`](../packages/util/keyed-lock) |
| [`fs-network-drive`](../packages/fs/fs-network-drive) | `fs` | [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`keyed-lock`](../packages/util/keyed-lock), [`llm`](../packages/llm/llm), [`network-drive`](../packages/fs/network-drive), [`sandbox`](../packages/sandbox/sandbox) |
...
| [`web-fetch-http`](../packages/web/web-fetch-http) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings), [`timeout`](../packages/util/timeout), [`web`](../packages/web/web) |
...
| [`web-search-exa`](../packages/web/web-search-exa) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`launch-environment`](../packages/util/launch-environment), [`settings`](../packages/settings/settings), [`web`](../packages/web/web) |
| [`web-search-perplexity`](../packages/web/web-search-perplexity) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`launch-environment`](../packages/util/launch-environment), [`settings`](../packages/settings/settings), [`web`](../packages/web/web) |
...
| [`fs-e2b`](../packages/e2b/fs-e2b) | `e2b` | [`e2b`](../packages/e2b/e2b), [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`keyed-lock`](../packages/util/keyed-lock) |
...
| [`approval-adversary`](../packages/guard/approval-adversary) | `guard` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`timeout`](../packages/util/timeout), [`user-approval`](../packages/interaction/user-approval) |
| [`approval-assessor`](../packages/guard/approval-assessor) | `guard` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`user-approval`](../packages/interaction/user-approval) |
...
| [`llm-litert`](../packages/llm/llm-litert) | `llm` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`llm-pi-ai`](../packages/llm/llm-pi-ai), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout) |
...
| [`web-fetch-playwright`](../packages/web/web-fetch-playwright) | `web` | [`capacity-gate`](../packages/util/capacity-gate), [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings), [`timeout`](../packages/util/timeout), [`web`](../packages/web/web), [`web-fetch-http`](../packages/web/web-fetch-http) |
...
| [`hook-protocol`](../packages/hooks/hook-protocol) | `hooks` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`shell`](../packages/shell/shell), [`tools`](../packages/core/tools) |
| [`hosted-drive`](../packages/bundle/hosted-drive) | `bundle` | [`fs`](../packages/fs/fs), [`fs-network-drive`](../packages/fs/fs-network-drive), [`invariants`](../packages/runtime-diagnostics/invariants), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy) |
...
| [`file-reference-local`](../packages/context/file-reference-local) | `context` | [`agent`](../packages/core/agent), [`file-reference`](../packages/context/file-reference), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`tool-lsp`](../packages/lsp/tool-lsp) | `lsp` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`lsp`](../packages/lsp/lsp), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`timeout`](../packages/util/timeout), [`tools`](../packages/core/tools) |
...
| [`tool-shell-persistent`](../packages/shell/tool-shell-persistent) | `shell` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`terminal`](../packages/terminal/terminal), [`timeout`](../packages/util/timeout), [`tools`](../packages/core/tools) |
...
| [`tool-goal`](../packages/goal/tool-goal) | `goal` | [`agent`](../packages/core/agent), [`goal`](../packages/goal/goal), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| [`agent-team`](../packages/subagent/agent-team) | `subagent` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`keyed-lock`](../packages/util/keyed-lock), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`settings`](../packages/settings/settings), [`subagent`](../packages/subagent/subagent), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
...
| [`tool-agent-team`](../packages/subagent/tool-agent-team) | `subagent` | [`agent`](../packages/core/agent), [`agent-team`](../packages/subagent/agent-team), [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| [`api-remotes`](../packages/api/remotes) | `api` | [`agent-default-model`](../packages/core/agent-default-model), [`agent-presets`](../packages/preset/agent-presets), [`api-gateway`](../packages/api/gateway), [`api-session-controller`](../packages/api/session-controller), [`api-settings-controller`](../packages/api/settings-controller), [`api-workspace-controller`](../packages/api/workspace-controller), [`commands`](../packages/interaction/commands), [`cordis-host-runner`](../packages/extensions/cordis-host-runner), [`credentials`](../packages/credentials/credentials), [`file-reference`](../packages/context/file-reference), [`goal`](../packages/goal/goal), [`host-plugin-inventory`](../packages/host/plugin-inventory), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`message-feedback`](../packages/feedback/message-feedback), [`session`](../packages/core/session), [`session-reference`](../packages/context/session-reference), [`settings`](../packages/settings/settings), [`subagent`](../packages/subagent/subagent), [`tool-subagent`](../packages/subagent/tool-subagent), [`user-approval`](../packages/interaction/user-approval), [`user-questions`](../packages/interaction/user-questions) |
...
| [`client-ui-settings-plugins`](../packages/client/ui-settings-plugins) | `client` | [`api-remotes`](../packages/api/remotes), [`api-session-controller`](../packages/api/session-controller), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-settings`](../packages/client/ui-settings), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`cordis-client-runner`](../packages/extensions/cordis-client-runner) | `extensions` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-modules`](../packages/client/modules), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-theme`](../packages/client/ui-theme), [`cordis-host-runner`](../packages/extensions/cordis-host-runner), [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`client-ui-conversation`](../packages/client/ui-conversation) | `client` | [`api-remotes`](../packages/api/remotes), [`api-session-controller`](../packages/api/session-controller), [`api-workspace-controller`](../packages/api/workspace-controller), [`attachment`](../packages/attachment/attachment), [`brand`](../packages/util/brand), [`client-locale`](../packages/client/locale), [`client-ui-layout`](../packages/client/ui-layout), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-session`](../packages/client/ui-session), [`client-ui-settings`](../packages/client/ui-settings), [`client-ui-workspace`](../packages/client/ui-workspace), [`commands`](../packages/interaction/commands), [`goal`](../packages/goal/goal), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`llm-retry`](../packages/llm/llm-retry), [`permission-presets`](../packages/interaction/permission-presets), [`plan-mode`](../packages/plan/plan-mode), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`token-meter`](../packages/llm/token-meter), [`tool-todo`](../packages/todo/tool-todo), [`tools`](../packages/core/tools), [`util-crypto`](../packages/util/crypto), [`util-workspace-path`](../packages/util/workspace-path), [`workspace`](../packages/workspace/workspace) |
...
| [`client-ui-agent-team`](../packages/client/ui-agent-team) | `client` | [`agent-team`](../packages/subagent/agent-team), [`api-remotes`](../packages/api/remotes), [`api-session-controller`](../packages/api/session-controller), [`client-locale`](../packages/client/locale), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-session`](../packages/client/ui-session), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`typert-protocol`](../packages/typert/protocol) |
...
| [`client-ui-directory-picker-browse`](../packages/client/ui-directory-picker-browse) | `client` | [`api-remotes`](../packages/api/remotes), [`client-locale`](../packages/client/locale), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-workspace`](../packages/client/ui-workspace), [`host-directory-picker`](../packages/host/directory-picker), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-workspace-roots`](../packages/client/ui-workspace-roots) | `client` | [`api-remotes`](../packages/api/remotes), [`api-session-controller`](../packages/api/session-controller), [`client-locale`](../packages/client/locale), [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-session`](../packages/client/ui-session), [`client-ui-workspace`](../packages/client/ui-workspace), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`typert-protocol`](../packages/typert/protocol) |
