<!-- 英文源文件由 scripts/gen-cordis-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `bun run gen-cordis-catalog` 更新英文，再更新本文件并运行 `bun run verify-translation-pairing --write docs/cordis-api/fiber.md` 重新记录配对。 -->
...
[源码](../../vendor/cordis/src/fiber.ts#L709)
...
[源码](../../vendor/cordis/src/fiber.ts#L723)
...
[源码](../../vendor/cordis/src/fiber.ts#L741)
